...
(function () {
    ...
    if (element.currentStyle)
		...
		if (window.getComputedStyle)
			return (document.defaultView.getComputedStyle(element, null))[propertyName];
